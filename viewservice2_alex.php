...
<html>
    ...
    <body>
      ...
      // Check connection    
            ...
            {
                $stmt = $conn->prepare("SELECT * FROM service WHERE moduleyear=2 LIMIT $start,$max_entries");
                $stmt->execute();
      ...
      // Check connection    
        ...
        <div class="pagination">
         <?php
            ...
            if($page>=2){
                echo "<a href='viewservice2.php'?page=".($page-1).">Prev</a>";
                    }
                    
            for ($num=1; $num<=$max_pages;$num++){
                if ($num==$page){
                    $pagelink.="<a onclick='gotospecificpage()'class= 'active' href='viewservice2.php'?page=".$num."'>".$num."</a>";
                }else{
                    $pagelink.="<a href='viewservice2.php'?page=".$num."'>".$num."</a>";
            ...
            echo $pagelink;
            if ($page <$max_pages){
                echo "<a href='viewservice2.php?page=".($page+1)."'>Next</a>";
            }
...
{   
        ...
        window.location.href = 'viewservice2.php?page='+page;   
}   
      function gotopage()
{
          var page=document.getElementById("page").value;
