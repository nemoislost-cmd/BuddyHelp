...
<?php
    ...
    $student_id=$_SESSION["student_id"];
             ...
             global $errorMsg,$success,$start,$max_entries,$ran,$student_id,$paid;
      ...
      // Check connection    
            ...
            {
                $stmt="UPDATE service_has_product SET recipt_id = ".$ran.", paid = ".$paid." WHERE student_id=".$_SESSION["student_id"]." and recipt_id is null";
