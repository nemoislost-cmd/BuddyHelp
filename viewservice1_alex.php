...
<html>
    ...
    <body>
      ...
      // Check connection    
            ...
            {
                $stmt = $conn->prepare("SELECT * FROM service WHERE moduleyear=1 LIMIT $start,$max_entries");
                $stmt->execute();
      ...
      // Check connection    
                ...
                <tbody>
                    ...
                    while ($row=$_SESSION['result']->fetch_assoc()){
                        ...
                        if (isset($_SESSION["student_id"])){
                            echo "<td><div class='icon1'><a href='viewservices.php?id=".$row["service_id"]."' ><img class='icon1' src='images/viewlisting.png' width='65px' height='75px' alt='View Full Listing' /><p class='icondescription1'>Click here to view Full Listing!</p></a></div>";
        ...
        <div class="pagination">
         <?php
            ...
            if($page>=2){
                echo "<a href='viewservice1.php'?page=".($page-1).">Prev</a>";
                    }
                    
            for ($num=1; $num<=$max_pages;$num++){
                if ($num==$page){
                    $pagelink.="<a onclick='gotospecificpage()'class= 'active' href='viewservice1.php'?page=".$num."'>".$num."</a>";
                }else{
                    $pagelink.="<a href='viewservice1.php'?page=".$num."'>".$num."</a>";
            ...
            echo $pagelink;
            if ($page <$max_pages){
                echo "<a href='viewservice1.php?page=".($page+1)."'>Next</a>";
            }
...
{   
        ...
        window.location.href = 'viewservice1.php?page='+page;   
}   
      function gotopage()
{
          var page=document.getElementById("page").value;
